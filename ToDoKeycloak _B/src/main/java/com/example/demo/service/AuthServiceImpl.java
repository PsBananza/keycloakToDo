...
public class AuthServiceImpl implements AuthService{
    ...
    public UserLoginDto getAccessToken(User user){
        MultiValueMap<String, String> paramMap = new LinkedMultiValueMap<>();
        paramMap.add(CLIENT_ID, serviceClient);
        paramMap.add(CLIENT_SECRET, serviceSecret);
        ...
        UserLoginDto userLoginDto = new UserLoginDto().setToken(response.getBody().getAccessToken()).setRole(response.getBody().getScope());
        return userLoginDto;
    }
